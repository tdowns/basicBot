...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://rawgit.com/tdowns/basicBot/master/lang/langIndex.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            lockskipReasons: [
                ...
                ["unavailable", "The song you played was not available for some users. Please consider replacing it with a different version or song in your playlist."],
            ...
            blacklists: {
                ...
                OP: "https://rawgit.com/tdowns/basicBot-customization/master/blacklists/ExampleOPlist.json"
            }
        },
        room: {
            users: [],
        ...
        chatUtilities: {
            ...
            curses: [
                'nigger', 'faggot', 'nigga', 'niqqa', 'motherfucker', 'modafocka', 'fag', 'fuck you', 'fuck', 'fucking', 'bitch', 'cunt'
            ]
        },
        connectAPI: function () {
            this.proxy = {
                    ...
                    if (!basicBot.commands.executable(this.rank, chat)) return void (0);
                        ...
                        if (space === -1) {
                            ...
                            if (user === false || !user.inRoom) {
                                ...
                                return API.sendChat(subChat(basicBot.chat.taco, {nameto: user.username, namefrom: chat.un, taco: this.getTaco()}));
                            }
                        }
                    }
                }
